...
export default function Giris() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: "#fff", borderRadius: 14, boxShadow: "0 4px 16px #e1e3e8", padding: 36, minWidth: 350,
      }}>
        <h2 style={{
          fontSize: 24, fontWeight: 700, color: "#223555", textAlign: "center", marginBottom: 24,
        }}>
          Giriş Yap
        </h2>
        <form onSubmit={handleSubmit}>
          <input
            ...
            style={{
              ...
              border: "1px solid #bbb", borderRadius: 8, fontSize: 15,
          ...
          <button
            type="submit"
            style={{
              width: "100%", background: "#2563eb", color: "#fff", padding: 12,
