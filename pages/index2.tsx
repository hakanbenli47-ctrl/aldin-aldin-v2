                ...
                <div className="inner" style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(210px,1fr))', gap:14, marginTop:12 }}>
                  {indirimliUrunler.slice(0,8).map(p=>(
                    <div key={p.id}
                      ...
                      style={{ cursor:'pointer', background:'#ffffffcc', border:'1px solid #a7f3d0', borderRadius:12, padding:10, position:'relative' }}>
...
<div id="urunler" className="scroll-anchor" />
                ...
                <div style={{ display:'flex', alignItems:'center', gap:10, flexWrap:'wrap', margin:'6px 0 14px' }}>
                  <button onClick={()=> setOnlyDiscounted(v=>!v)}
                    style={{
                      ...
                      background: onlyDiscounted ? '#e0f2fe' : '#fff', fontWeight:800, fontSize:13, cursor:'pointer'
                    }}>İndirimli</button>
                  ...
                  <button onClick={()=> setOnlyNew(v=>!v)}
                    style={{
                      padding:'8px 12px', borderRadius:999, border:'1px solid #e2e8f0',
                      background: onlyNew ? '#e0f2fe' : '#fff', fontWeight:800, fontSize:13, cursor:'pointer'
                    }}>Yeni</button>
        ...
        <style jsx global>{`
          :root{
            ...
            --success: #10b981;
            --success-500: #10b981;
            --danger:  #0ea5e9;           /* kırmızıyı kullanmıyoruz; maviye çekildi */
            --warning: #14b8a6;           /* teal-500 (yıldız vs.) */
            --price-discount: #0ea5e9;    /* indirim mavi */
            --ink-900: #0f172a;
            --bg-grad-end: #e0f7fa;       /* arka plan degrade sonu */
            ...
            --surface: #f8fafc;
            --surface-200: #f1f5f9;
            --highlight: #e0f2fe;         /* featured kart zemin */
            --highlight-border: #bae6fd;
            --highlight-img-border: #bfdbfe;
            --note-bg: #ecfeff;           /* bilgi uyarı arkaplan */
            --note-fg: #0e7490;           /* bilgi uyarı yazı */
            --attention: #0ea5e9;
            --attention-300: #7dd3fc;
            --yellow-300: #bae6fd;        /* sarı yerine mavi tonu */
            --card: #ffffffcc;            /* şeffaf beyaz kart */
            --card-bg: #ffffffcc;
          }
          ...
          .hero-slide {
            ...
            min-height: 180px;
            max-height: 420px;
            background: linear-gradient(135deg,#e0f2fe,#ecfeff); /* mavi/teal */
          ...
          .hero-btn {
            ...
            color: #fff; border: none; border-radius: 10px; padding: 10px 14px; font-weight: 800; cursor: pointer;
          }
          ...
          .hero-dots{
            display:flex; gap:6px; justify-content:center; margin:8px 0 0; position: relative;
          }
          .hero-dots button{
            width:8px; height:8px; border-radius:999px; border:0; background:#dbeafe; transition: transform .15s, background .15s;
          }
          ...
          /* Grid ve responsive ayarlar (değişmeden) */
          ...
          @media (max-width: 640px){
            .ilanGrid{ grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; }
          }
          ...
          @media (max-width: 380px){
            .ilanGrid > div{ flex-basis: 88vw; max-width: 88vw; }
          }
          ...
          /* Kart arka planlarını yeşil-mavi temaya yaklaştır (yapıyı bozmadan) */
          .pwa-header,
